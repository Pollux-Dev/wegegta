...
export interface PluginTodoTodo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    timeAllocated: Attribute.Time & Attribute.DefaultTo<'00:00:00'>;
...
export interface PluginSmsServiceMessage extends Schema.CollectionType {
  ...
  attributes: {
    messageType: Attribute.Enumeration<['sms', 'email']>;
    to: Attribute.String;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    form: Attribute.DynamicZone<
      ['form.checkbox', 'form.select', 'form.textfield', 'form.file-uploader']
    > &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
    ...
    link: Attribute.String &
      Attribute.CustomField<'plugin::generated-page-link.page-link'>;
...
declare module '@strapi/strapi' {
  export namespace Shared {
    export interface ContentTypes {
      ...
      'plugin::sms-service.message': PluginSmsServiceMessage;
